...
//    private int age;
    ...
    public User(int id, String usernamename, String lastName, String password){
        this.id = id;
    ...
    public User(int id, String username, String lastName, String password, Set<Role> roles){
        this.id = id;
